...
public class Miska {
  ...
  public void nalozSiJedenKus(NadobaSKusovouSurovinou ceho) {
  ...
  public void nalozSiCelyObsah(NadobaSeSypkouSurovinou zCeho) {
  ...
  public void nalozSiObsahJineMisky(Miska ktereMisky) {
    ...
    pocetOvoce += ktereMisky.pocetOvoce;
    nadobaNaCukr = ktereMisky.nadobaNaCukr;
    nadobaNaMouku = ktereMisky.nadobaNaMouku;
    nadobaNaMaslo = ktereMisky.nadobaNaMaslo;
    nadobaNaPrasekDoPeciva = ktereMisky.nadobaNaPrasekDoPeciva;
    hmotnostCukru += ktereMisky.hmotnostCukru;
    hmotnostMouky += ktereMisky.hmotnostMouky;
    hmotnostMasla += ktereMisky.hmotnostMasla;
    hmotnostPraskuDoPeciva += ktereMisky.hmotnostPraskuDoPeciva;
    ktereMisky.pocetVajec = 0;
    ktereMisky.pocetOvoce = 0;
    ktereMisky.hmotnostCukru = 0;
    ktereMisky.hmotnostMouky = 0;
    ktereMisky.hmotnostMasla = 0;
    ktereMisky.hmotnostPraskuDoPeciva = 0;
    ktereMisky.nadobaNaCukr = null;
    ktereMisky.nadobaNaMouku = null;
    ktereMisky.nadobaNaMaslo = null;
    ktereMisky.nadobaNaPrasekDoPeciva = null;
  ...
  public void nalozSiTrochu(NadobaSeSypkouSurovinou zCeho) {
